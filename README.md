...
2. Для поддержки загрузки файлов:
  ...
  ``` 
    ...
    file_uploads = On (если не установлено)
    post_max_size = 10M
  ```
...
1. Создадим 2 тестовых почтовых ящика на рамблере и разрешим получение писем для сторонних сайтов во вкладке программы:
  ```логин practicaltaskevgrafova2@rambler.ru пароль PracticalTaskEvgrafova2```
  ```логин practicaltaskevgrafova@rambler.ru пароль PracticalTaskEvgrafova1```
